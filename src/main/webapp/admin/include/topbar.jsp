	...
	<ul class="navbar-nav ml-auto">
			...
			<div
				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src="${pageContext.request.contextPath}/admin/assets/img/undraw_profile_1.svg" alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src="${pageContext.request.contextPath}/admin/assets/img/undraw_profile_2.svg" alt="">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle" src="${pageContext.request.contextPath}/admin/assets/img/undraw_profile_3.svg" alt="">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				...
				src="${pageContext.request.contextPath}/admin/assets/img/undraw_profile.svg">
