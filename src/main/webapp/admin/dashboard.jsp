...
<body id="page-top">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
                      style="width: 25rem;"
                      src="${pageContext.request.contextPath}/admin/assets/img/undraw_posting_photo.svg"
                      alt="">
                  </div>
                  <p>
                    ...
                    updated collection of beautiful svg images that you
                    can use completely free and without attribution!
                  </p>
                  <a target="_blank" rel="nofollow"
                    href="https://undraw.co/">Browse Illustrations
                    on unDraw &rarr;</a>
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <p>SB Admin 2 makes extensive use of Bootstrap 4
                    ...
                    classes.</p>
                  <p class="mb-0">Before working with this theme,
  ...
  <script
    src="${pageContext.request.contextPath}/admin/assets/js/demo/chart-area-demo.js"></script>
  <script
    src="${pageContext.request.contextPath}/admin/assets/js/demo/chart-pie-demo.js"></script>
